...
def train_and_evaluate_standard(params, percentage_of_training, verbose=True):
    """
    ...
    standard_model = Standard(params.NUMBER_OF_CLASSES)
    standard_model.build(input_shape=(params.NUMBER_OF_FEATURES,))
